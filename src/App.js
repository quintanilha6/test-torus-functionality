...
import NUMBER_ABI from './NUMBER_ABI'
...
class App extends React.Component {
  ...
  sendEth = () => {
    ...
    web3Obj.web3.eth.sendTransaction({
      from: account, to: '0x357573E1b99293Bc09b7392B560b3C336c22690C',
  ...
  setNumber = () => {
    const numberInstance = new web3Obj.web3.eth.Contract(NUMBER_ABI, '0x8856F7e931fA0c2bd7144EcC57f45148556A3975')
    numberInstance.methods.setNumber(5).send(
      {
        from: this.state.account
      },
      (err, hash) => {
  ...
  displayKeys = () => {
    web3Obj.torus.showWallet('settings');
  }
      ...
      <div className="App">
        ...
        {account !== null && (
          <div>
            ...
            <button onClick={this.displayKeys}>Keys</button>
